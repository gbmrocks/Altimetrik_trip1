...
public class Room {
	 ...
	 public Total_amount getTotal_amountObject() {
		return Total_amountObject;
	}

	public void setTotal_amountObject(Total_amount total_amountObject) {
		Total_amountObject = total_amountObject;
	}
	...
	public Room_type_info getRoom_type_infoObject() {
		return Room_type_infoObject;
	}

	public void setRoom_type_infoObject(Room_type_info room_type_infoObject) {
		Room_type_infoObject = room_type_infoObject;
	}
